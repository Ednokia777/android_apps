...
public class Level15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.ispitanie_vodorod_bombi);
        ...
        textdescriptionEnd.setText(R.string.level15End);
        ...
        img_down_left.setImageResource(array.images15[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts15[numDownLeft]);//достаем из массива текст
        ...
        img_down_right.setImageResource(array.images15[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts15[numDownRight]);//достаем из массива текст
