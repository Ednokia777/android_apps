...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.previewim3);
        ...
        textdescriptionEnd.setText(R.string.level3End);
        ...
        numLeft = random.nextInt(26);//генерируем случайное число от 0 до 16.
        ...
        numRight = random.nextInt(26);//генерируем случайное число от 0 до 16.
        ...
        numDownLeft = random.nextInt(26);//генерируем случайное число от 0 до 16.
        while(numLeft == numDownLeft || numRight == numDownLeft){
            numDownLeft = random.nextInt(26);
            if(numLeft == numDownLeft || numRight == numDownLeft){
                continue;
            }
        }
        img_down_left.setImageResource(array.images3[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts3[numDownLeft]);//достаем из массива текст

        numDownRight = random.nextInt(26);//генерируем случайное число от 0 до 16.
        while(numLeft == numDownRight || numRight == numDownRight || numDownLeft == numDownRight){
            numDownRight = random.nextInt(26);
            if(numLeft == numDownRight || numRight == numDownRight || numDownLeft == numDownRight){
                continue;
            }
        }
        img_down_right.setImageResource(array.images3[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts3[numDownRight]);//достаем из массива текст
