...
public class Level8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.expedicia_kruzersterna);
        ...
        textdescriptionEnd.setText(R.string.level8End);
        ...
        text_left.setText(array.texts8[numLeft]);//достаем из массива текст
        ...
        text_right.setText(array.texts8[numRight]);//достаем из массива текст
        ...
        img_down_left.setImageResource(array.images8[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts8[numDownLeft]);//достаем из массива текст
        ...
        img_down_right.setImageResource(array.images8[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts8[numDownRight]);//достаем из массива текст
