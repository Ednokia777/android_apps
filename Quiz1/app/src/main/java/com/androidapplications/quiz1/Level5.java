...
public class Level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.nachalo_velikogo_posolstva);
        ...
        textdescriptionEnd.setText(R.string.level5End);
        ...
        img_down_left.setImageResource(array.images5[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts5[numDownLeft]);//достаем из массива текст
        ...
        img_down_right.setImageResource(array.images5[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts5[numDownRight]);//достаем из массива текст
