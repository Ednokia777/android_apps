...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.osnovanie_pitera);
        ...
        textdescriptionEnd.setText(R.string.level6End);
        ...
        numRight = random.nextInt(22);//генерируем случайное число от 0 до 16.
        ...
        numDownLeft = random.nextInt(22);//генерируем случайное число от 0 до 16.
        while(numLeft == numDownLeft || numRight == numDownLeft){
            numDownLeft = random.nextInt(22);
            if(numLeft == numDownLeft || numRight == numDownLeft){
                continue;
            }
        }
        img_down_left.setImageResource(array.images6[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts6[numDownLeft]);//достаем из массива текст

        numDownRight = random.nextInt(22);//генерируем случайное число от 0 до 16.
        while(numLeft == numDownRight || numRight == numDownRight || numDownLeft == numDownRight){
            numDownRight = random.nextInt(22);
            if(numLeft == numDownRight || numRight == numDownRight || numDownLeft == numDownRight){
                continue;
            }
        }
        img_down_right.setImageResource(array.images6[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts6[numDownRight]);//достаем из массива текст
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()== MotionEvent.ACTION_DOWN){
                    ...
                    if(count == 20){
                        ...
                        //Цикл с предусловием, проверяющий равенство событий - начало
                        numLeft = random.nextInt(22);//генерируем случайное число от 0 до 16.
                        img_left.setImageResource(array.images6[numLeft]);//достаем из массива картинку
                        text_left.setText(array.texts6[numLeft]);//достаем из массива текст
