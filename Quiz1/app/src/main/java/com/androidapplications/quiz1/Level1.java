...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_down_left.setImageResource(array.images1[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts1[numDownLeft]);//достаем из массива текст
        ...
        img_down_right.setImageResource(array.images1[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts1[numDownRight]);//достаем из массива текст
