...
public class Level17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.previewdialog);//пуьб к макету диалога
        ...
        previewimg.setImageResource(R.drawable.defolt);
        ...
        dialogEnd.setContentView(R.layout.dialogfinish);//пуьб к макету диалога
        ...
        numLeft = random.nextInt(20);//генерируем случайное число от 0 до 16.
        img_left.setImageResource(array.images17[numLeft]);//достаем из массива картинку
        text_left.setText(array.texts17[numLeft]);//достаем из массива текст

        numRight = random.nextInt(20);//генерируем случайное число от 0 до 16.
        ...
        text_right.setText(array.texts17[numRight]);//достаем из массива текст

        numDownLeft = random.nextInt(20);//генерируем случайное число от 0 до 16.
        while(numLeft == numDownLeft || numRight == numDownLeft){
            numDownLeft = random.nextInt(20);
            if(numLeft == numDownLeft || numRight == numDownLeft){
                continue;
            }
        }
        img_down_left.setImageResource(array.images17[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts17[numDownLeft]);//достаем из массива текст

        numDownRight = random.nextInt(20);//генерируем случайное число от 0 до 16.
        while(numLeft == numDownRight || numRight == numDownRight || numDownLeft == numDownRight){
            numDownRight = random.nextInt(20);
            if(numLeft == numDownRight || numRight == numDownRight || numDownLeft == numDownRight){
                continue;
            }
        }
        img_down_right.setImageResource(array.images17[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts17[numDownRight]);//достаем из массива текст
