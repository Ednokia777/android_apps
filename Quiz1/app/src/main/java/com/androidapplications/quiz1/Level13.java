...
public class Level13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.obrazovanie_sssr);
        ...
        textdescriptionEnd.setText(R.string.level13End);
        ...
        img_down_left.setImageResource(array.images13[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts13[numDownLeft]);//достаем из массива текст
        ...
        img_down_right.setImageResource(array.images13[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts13[numDownRight]);//достаем из массива текст
