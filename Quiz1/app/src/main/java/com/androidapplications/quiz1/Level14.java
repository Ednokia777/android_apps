...
public class Level14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.nachalo_vtoroy_mirovoi);
        ...
        textdescriptionEnd.setText(R.string.level14End);
        ...
        img_down_left.setImageResource(array.images14[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts14[numDownLeft]);//достаем из массива текст
        ...
        img_down_right.setImageResource(array.images14[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts14[numDownRight]);//достаем из массива текст
