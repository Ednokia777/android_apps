...
public class Level11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.popov_radio);
        ...
        textdescriptionEnd.setText(R.string.level11End);
        ...
        numLeft = random.nextInt(17);//генерируем случайное число от 0 до 16.
        ...
        numRight = random.nextInt(17);//генерируем случайное число от 0 до 16.
        ...
        numDownLeft = random.nextInt(17);//генерируем случайное число от 0 до 16.
        while(numLeft == numDownLeft || numRight == numDownLeft){
            numDownLeft = random.nextInt(17);
            if(numLeft == numDownLeft || numRight == numDownLeft){
                continue;
            }
        }
        img_down_left.setImageResource(array.images11[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts11[numDownLeft]);//достаем из массива текст

        numDownRight = random.nextInt(17);//генерируем случайное число от 0 до 16.
        while(numLeft == numDownRight || numRight == numDownRight || numDownLeft == numDownRight){
            numDownRight = random.nextInt(17);
            if(numLeft == numDownRight || numRight == numDownRight || numDownLeft == numDownRight){
                continue;
            }
        }
        img_down_right.setImageResource(array.images11[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts11[numDownRight]);//достаем из массива текст
