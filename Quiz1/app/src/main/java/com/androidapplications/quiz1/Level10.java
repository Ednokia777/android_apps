...
public class Level10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.nokolay_vtoroy_nachalo);
        ...
        numLeft = random.nextInt(18);//генерируем случайное число от 0 до 16.
        ...
        numRight = random.nextInt(18);//генерируем случайное число от 0 до 16.
        while(numLeft == numRight){
            numRight = random.nextInt(18);
            if(numLeft == numRight){
                continue;
            }
        }
        ...
        numDownLeft = random.nextInt(18);//генерируем случайное число от 0 до 16.
        while(numLeft == numDownLeft || numRight == numDownLeft){
            numDownLeft = random.nextInt(18);
            if(numLeft == numDownLeft || numRight == numDownLeft){
                continue;
            }
        }
        img_down_left.setImageResource(array.images10[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts10[numDownLeft]);//достаем из массива текст

        numDownRight = random.nextInt(18);//генерируем случайное число от 0 до 16.
        while(numLeft == numDownRight || numRight == numDownRight || numDownLeft == numDownRight){
            numDownRight = random.nextInt(18);
            if(numLeft == numDownRight || numRight == numDownRight || numDownLeft == numDownRight){
                continue;
            }
        }
        img_down_right.setImageResource(array.images10[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts10[numDownRight]);//достаем из массива текст
