...
public class Level16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.polet_gagarina_v_kosmos);
        ...
        text_left.setText(array.texts16[numLeft]);//достаем из массива текст
        ...
        text_right.setText(array.texts16[numRight]);//достаем из массива текст
        ...
        img_down_left.setImageResource(array.images16[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts16[numDownLeft]);//достаем из массива текст
        ...
        img_down_right.setImageResource(array.images16[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts16[numDownRight]);//достаем из массива текст
