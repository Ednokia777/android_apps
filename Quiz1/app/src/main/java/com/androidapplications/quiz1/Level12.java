...
public class Level12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.otrechenie_nikolaya_vtorogo);
        ...
        img_down_left.setImageResource(array.images12[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts12[numDownLeft]);//достаем из массива текст
        ...
        img_down_right.setImageResource(array.images12[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts12[numDownRight]);//достаем из массива текст
