...
public class Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.manifest_trehdnevnoy_barshine);
        ...
        textdescriptionEnd.setText(R.string.level7End);
        ...
        text_left.setText(array.texts7[numLeft]);//достаем из массива текст
        ...
        text_right.setText(array.texts7[numRight]);//достаем из массива текст
        ...
        img_down_left.setImageResource(array.images7[numDownLeft]);//достаем из массива картинку
        text_down_left.setText(array.texts7[numDownLeft]);//достаем из массива текст
        ...
        img_down_right.setImageResource(array.images7[numDownRight]);//достаем из массива картинку
        text_down_right.setText(array.texts7[numDownRight]);//достаем из массива текст
